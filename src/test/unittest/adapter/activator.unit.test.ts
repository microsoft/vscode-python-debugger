...
suite('Debugging - Adapter Factory and logger Registration', () => {
    ...
    test('Register Debug adapter factory', async () => {
        ...
        // verify(debugService.registerDebugAdapterTrackerFactory('debugpy', instance(loggingFactory))).once();
        // verify(
        //     debugService.registerDebugAdapterTrackerFactory('debugpy', instance(debuggerPromptFactory)),
        // ).once();
        // verify(
