...
const extensionConfig = {
  ...
  externals: {
    ...
    '@vscode/windows-process-tree': 'commonjs @vscode/windows-process-tree', // native addon (.node binary); webpack cannot bundle it. Loaded from VS Code's node_modules.asar (or node_modules) using eval('require') to bypass webpack's require interception
  },
  resolve: {
